...
int printhelp(){
    ...
    cout << "\tRamEX IRCA Clean Data Function: " << endl;
    cout << "Usage:" << endl;
    cout << "RamEX-IRCA-Clean-Data [Option]" << endl;
    cout << "Options: " << endl;
...
int main(int argc, char * argv[]){
    ...
    sprintf(command, "Rscript %s/IRCA_clean_data.R -i %s -o %s", R_path.c_str(), Infilename.c_str(), Out_path.c_str());
    Run_With_Error(command, Error_file.c_str());
    cout << endl << "IRCA Raman Data Cleaning Finished"<< endl;
