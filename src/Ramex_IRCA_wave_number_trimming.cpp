...
int printhelp(){
    ...
    cout << "\tRamEX IRCA Wave Number Trimming Function: " << endl;
    cout << "Usage:" << endl;
    cout << "RamEX-IRCA-wave-number-trimming [Option]" << endl;
    cout << "Options: " << endl;
...
int main(int argc, char * argv[]){
    ...
    sprintf(command, "Rscript %s/IRCA_wnt.R  -i %s -o %s", R_path.c_str(), Infilename.c_str(), Out_path.c_str());
    Run_With_Error(command, Error_file.c_str());
    cout << endl << "IRCA Raman Wave Number Trimming Finished"<< endl;
